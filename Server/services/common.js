...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "p.thakur.144.ram@gmail.com", // gmail
...
exports.sendMail = async function ({ to, subject, text, html }) {
  let info = await transporter.sendMail({
    from: '"Apna Shop" <p.thakur.144.ram@gmail.com>', // sender address
    to,
    subject,
    text,
    html,
    ...
    <tr>
      <td align="center" bgcolor="#D2C7BA" style="padding: 24px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">To stop receiving these emails, you can <a href="https://mern-ecommerce-gold.vercel.app" target="_blank">unsubscribe</a> at any time.</p>
